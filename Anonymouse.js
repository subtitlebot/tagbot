...
*🈲 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴 -  𝙴𝙽𝙶𝙻𝙸𝚂𝙷*
*🎥 𝚀𝚄𝙻𝙸𝚃𝚈 - 720𝚙*
*🔊 𝙰𝚄𝙳𝙸𝙾 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 - 2 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 66𝚔𝚋𝚙𝚜*
*⚙️ 𝙱𝚒𝚝 𝙳𝙴𝙿𝚃𝙷 - 10𝚋𝚒𝚝𝚜 1 𝙱𝙸𝙻𝙸𝙾𝙽 𝙲𝙾𝙻𝙾𝚁*
*🔏 𝙴𝙽𝙲𝙾𝙳𝙴 - 𝙷.264 | 𝙷𝙴𝚅𝙲 | 𝚆𝙴𝙱-𝙳𝙻*
*📺 𝙴𝙿𝙸𝚂𝙾𝙳𝙴 - 02 (The Rogue Prince)*
*⏳𝚁𝚄𝙽 𝚃𝙸𝙼𝙴 -  50𝙼 27𝚂*
*🧾 𝚂𝚄𝙱𝚃𝙸𝚃𝙻𝙴 - සිංහල*
*📥 𝚂𝙸𝚉𝙴 - 189𝙼𝙱*
...
⚔️🛡️ 𝔽𝕀ℝ𝔼 𝕄𝕆𝕍𝕀𝔼 𝔾ℝ𝕆𝕌ℙ ⚔️🛡️`
                ...
                let buttons = [
                    {buttonId: 'ft-id1-02', buttonText: {displayText: 'DOWNLOAD'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://www.lydogbilde.no/wp-content/uploads/2022/08/House-of-the-Dragon-sesong-1_44.jpg'},
                    caption: charlie ,
...
//house of dragon
             ...
             if (/ft-id1-02/.test(command)) link = 'https://drive.google.com/u/6/uc?id=1NVJbn3tYvs3cx7TMsQLN5idPDB8TnwaQ&export=download&confirm=t&uuid=feb05272-3c11-4793-a40a-80a222319cb0'
...
//tv series name
	     ...
	     if (/ft-id1-02/.test(command)) name = '𝙷𝙾𝚄𝚂𝙴 𝙾𝙵 𝚃𝙷𝙴 𝙳𝚁𝙰𝙶𝙾𝙽 (2022) S1 E2 🔥Fire tv series by anony-x bot🔥.mkv'
//the sandman
